...
process FASTQC{
    tag "${base}"
    publishDir "${params.outdir}/outputs/quality_control/fastqc", mode: 'copy',
...
process TX{
    publishDir "${params.outdir}/outputs/reference", mode: 'copy',
        saveAs: { params.save_transcriptome ? "outputs/reference/transcriptome/${it}" : null }
...
process KALLISTO_QUANT{
    publishDir "${params.outdir}/outputs/quantification", mode: 'copy'
...
process MULTIQC{
    publishDir "${params.outdir}/outputs/quality_control/multiqc", mode: 'copy'
